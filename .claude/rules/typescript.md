...
- Put a plain overload for the fully-supplied argument shape ahead of a conditional-type-gated one; the conditional never resolves inside a generic scope.
